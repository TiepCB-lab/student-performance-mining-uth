...
Dự án này xây dựng khung Backend API nhằm phục vụ cho bài toán phân tích và dự đoán điểm số cuối kỳ (G3) của sinh viên dựa trên tập dữ liệu học tập và thói quen sinh hoạt từ file [student_data.csv](data/student_data.csv).
...
│
├── frontend/         # Thư mục chứa mã nguồn giao diện Web (Phát triển trong tương lai)
